...
router = APIRouter(prefix="/api/developer/viral-analysis", tags=["developer-viral-analysis"])
...
def list_jobs(
    ...
    return ok(ViralAnalysisService(conn).list_jobs_for_developer(page, page_size))
